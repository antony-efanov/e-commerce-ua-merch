...
export function Card({ 
  ...
  const { 
    onClickFav,
    isItemAdded, 
    isItemFavorited } = useContext(AppContext);
    ...
    <>
    {
      loading ? (
        ...
        <div className="card">
          ...
          <button onClick={onFav} className={isItemFavorited(parentID) ? "card__favbtn card__favbtn--active" : "card__favbtn"}>
          ...
          <div className="card__text">
            ...
            <div className="card__bottom">
              <div className="card__price-container">
                ...
                && onClickPlus 
                && <button 
                className={ isItemAdded(parentID) ? "card__checkbtn card__checkbtn--active" : "card__checkbtn"}
                onClick={onPlus}>
                </button>}
            </div>
          </div>
