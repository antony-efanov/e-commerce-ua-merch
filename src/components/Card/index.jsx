...
export function Card({
  ...
  const { onClickFav, isItemAdded, isItemFavorited } = useContext(AppContext);
  ...
  const availabilityClass = () => {
    return amount >= 15
      ? "card__availability card__availability--available"
      : amount < 15 && amount != 0
      ? "card__availability card__availability--ends"
      : amount == 0
      ? "card__availability card__availability--unavailable"
      : null;
  };
          ...
          <button
            ...
            className={
              isItemFavorited(parentID)
                ? "card__favbtn card__favbtn--active"
                : "card__favbtn"
            }
          >
            <svg
          ...
          <div className="card__text">
            ...
            <div className="card__bottom">
              <div className="card__price-container">
                <div className="card__pricename">ЦІНА</div>
