function Card({ imgUrl, title, price, number, onAddToCart }) {
  ...
  const onClickPlus = () => {
    onAddToCart({imgUrl, title, price, number});
  }
  ...
  return (
    <div className="card">
      ...
      <label htmlFor={favID} className="card__favbox--btn">
      ...
      <div className="card__text">
        ...
        <div className="card__bottom">
          ...
          <label onClick={onClickPlus} htmlFor={checkID} className="card__checkbox--btn"></label>
        </div>
      </div>
    </div>
  );
