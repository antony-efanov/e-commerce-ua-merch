  ...
  return (
    <header className="header">
      ...
      <div className="user">
        ...
        <Link to="/favorite" onClick={onFav} className={favOpened ? "user__btn user__btn--fav__active" : "user__btn user__btn--fav"}>
        ...
        <Link to="/orders" onClick={onOrders} className={ordersOpened ? "user__btn user__btn--user__active" : "user__btn user__btn--user"}>
          <svg width="25" height="25" viewBox="0 0 20 20" fill="none">
