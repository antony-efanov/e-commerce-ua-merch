function Card() {
  return (
    <div className="card">
      ...
      <a href="#"><img className="card__img" src="/img/items/t-shirt__it.webp" alt="t-shirt__it"/></a>
      <div className="card__text">
        <h5 className="card__title">
          <a href="#" >Футболка "А ти точно айтішнік?"</a>
        </h5>
        <div className="card__bottom">
          <div className="card__price-container">
            ...
            <h4 className="card__price">259<span>₴</span></h4>
          </div>
